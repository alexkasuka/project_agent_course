...
def main() -> None:
    parser = argparse.ArgumentParser(description="Build a local JSON knowledge base from course PDFs and notebooks.")
    parser.add_argument("--input-dir", default="course_materials", help="Directory with .pdf and .ipynb files.")
    ...
    supported_files = sorted([*input_dir.glob("*.pdf"), *input_dir.glob("*.ipynb")])
